...
const reviews: Review[] = [
    ...
    },
    {
        id: 5,
        name: '​Елена',
        text: 'Праздновали выпускной. Зал очень большой и светлый, с нашим количеством гостей было комфортно. Поварам спасибо за вкусные десерты, особенно за чизкейк — все ребята оценили. Отдельно хочу отметить, что алкоголь можно было привезти свой, это очень удобно. Всё прошло идеально!',
